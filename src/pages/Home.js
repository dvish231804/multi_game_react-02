        ...
        <div >
            ...
            <div className='container'>
                <div className="main-home-area">
                    ...
                    <div id="carouselExampleIndicators" className="carousel slide pd-top-110 mb-4" data-bs-ride="carousel">

                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img src="assets/img/banner/cal1.jpg" className="d-block w-100" alt="Slide 1" />
                            </div>
                            <div className="carousel-item">
                                <img src="assets/img/banner/cal1.jpg" className="d-block w-100" alt="Slide 2" />
                            </div>
                            <div className="carousel-item">
                                <img src="assets/img/banner/cal1.jpg" className="d-block w-100" alt="Slide 3" />
                            </div>
                        </div>
